    ...
    <section className="relative overflow-hidden bg-[#F7F2EA] py-16 lg:py-24">
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="mx-auto mb-10 max-w-4xl text-center lg:mb-14">
          <p className="mb-3 text-xs font-semibold uppercase tracking-[0.24em] text-primary">Jewelry Collection</p>
          <h2 className="font-heading text-3xl leading-tight text-foreground sm:text-4xl lg:text-6xl">Luxury Jewelry, Crafted Around You</h2>
