      ...
      <div className="container mx-auto px-6 lg:px-12 py-10 space-y-8 pb-28 md:pb-10">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <dl className="grid grid-cols-2 gap-3 text-sm rounded-[12px] border border-border p-4">
              ...
              <div><dt className="text-muted-foreground">Fluorescence</dt><dd>{diamond.fluorescence}</dd></div>
              ...
              <div><dt className="text-muted-foreground">Ratio</dt><dd>{diamond.ratio.toFixed(2)}</dd></div>
            ...
            <div className="border-t border-border pt-4 space-y-3">
              ...
              <p className="text-sm text-muted-foreground">Price / Carat: {currency(perCarat)}</p>
