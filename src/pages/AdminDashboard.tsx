...
const tiles = [
  { title: "Jewelry Manager", desc: "Manage rings, necklaces, bracelets, earrings", to: "/admin/jewelry", icon: Package },
    ...
    <AdminLayout>
      <section className="space-y-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          ...
          <div className="rounded-[12px] border border-border p-5 bg-secondary/30">
            <p className="text-xs uppercase tracking-[0.12em] text-muted-foreground mb-2">Jewelry Listings</p>
            <p className="font-heading text-2xl">{stats.activeJewelry} / {stats.totalJewelry}</p>
            <p className="text-xs mt-1 text-muted-foreground">Active / total</p>
          </div>
          <div className="rounded-[12px] border border-border p-5 bg-secondary/30">
