...
const Account = () => {
  const { wishlist, compare, ringBuilder } = useStore();
    ...
    <SiteLayout>
      <section className="container mx-auto px-6 lg:px-12 py-10">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          ...
          <div className="rounded-[12px] border border-border p-5 bg-secondary/30">
            <h2 className="font-heading text-lg mb-2">Ring Builder History</h2>
            <p className="text-sm text-muted-foreground">Current draft: {ringBuilder.diamondStoneId ?? "None"}</p>
          </div>
        </div>
      </section>
    </SiteLayout>
