...
import { deleteLocalJewelryItem, listLocalJewelryItems, upsertLocalJewelryItem } from "./_lib/local-jewelry-store.js";
    ...
    if (req.method === "POST") {
      ...
      const [row] = await sql`
        ...
        VALUES (
          ...
          ${item.stoneType || null},
          ${item.diamondWeight || null},
          ${item.setting || null},
          ${item.tags || null},
          ${JSON.stringify(item.metalImages)}::jsonb,
          ${JSON.stringify(item.galleryImages)}::jsonb,
          ${item.videoUrl || null},
          ${item.modelUrl || null},
    ...
    if (req.method === "PUT") {
      ...
      const [row] = await sql`
        ...
        SET
          ...
          stone_type = ${item.stoneType || null},
          diamond_weight = ${item.diamondWeight || null},
